...
const CartProduct = ({ cartProduct, deleteProductFromCart, setCheckedCarts, checkedCarts }) => {
        ...
        <div className="w-full border cursor-pointer border-primary">
            <label className="cursor-pointer w-full ">
                <div className="flex items-center gap-x-5">
                    <input
                        onClick={() => setCheckedCarts([...checkedCarts, cartProduct])}
                        className="peer sr-only"
                        value="Online service"
                        type="checkbox" />
                    <div className='flex items-center justify-between lg:px-7 w-full peer-checked:bg-primary'>
