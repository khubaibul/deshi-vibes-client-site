...
import { useGetCustomersQuery } from '../../../features/products/productsSlice';
            ...
            <div id="main-content" className="h-full w-full relative overflow-y-auto">
                <div className="px-4">
                    <div className="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                        <div className="bg-primary shadow p-4 sm:p-6 xl:p-8 ">
                    ...
                    <div className="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
                        <div className="bg-primary shadow mb-4 p-4 sm:p-6 h-full">
                            <div className="flex items-center justify-between mb-4">
                                <h3 className="text-xl font-bold leading-none text-gray-900">Latest Customers</h3>
                                <button className="text-sm font-medium text-cyan-600 hover:bg-gray-100 inline-flex items-center p-2">
                                    View all
                                </button>
                            </div>
